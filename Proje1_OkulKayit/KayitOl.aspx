    ...
    <header>
        <div class="container">
            <div class="header d-lg-flex justify-content-between align-items-center py-2 px-sm-2 px-1">
                <!-- logo -->
                <div id="logo">
                    <h1><a href="İndex.aspx">Okulumuz</a></h1>
                </div>
                <!-- //logo -->
                <!-- nav -->
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="Kullanıcı Adınız.."  CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">E-Posta</label>
                      <asp:TextBox ID="TextBox2" runat="server" placeholder="Mail@adresiniz"  CssClass="form-control"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehriniz</label>
  <asp:TextBox ID="TextBox3" runat="server" placeholder="Şehriniz"  CssClass="form-control" ></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şifreniz</label>
<asp:TextBox ID="TextBox4" runat="server" placeholder="******"  CssClass="form-control" TextMode="Password"></asp:TextBox>
                    </div>
